...
const AltDBScreener = () => {
  ...
  // ==================== FILTER OPTIONS ====================
  const { data: assetData, isLoading: assetLoading } =
    useGetAssetClassesQuery();
  ...
  } = useFilterFundsQuery(filters, {
    skip: !anyFilterSelected,
  });
  ...
  const optionFilter = (data) =>
    normalizeOptions(
      data?.data?.filter((i) => String(i.status) === "1") ?? []
    );
  ...
  const handleSort = (column) => {
    ...
    // Sort change => first page
    setCurrentPage(1);
  };

  // ==================== 1Y RETURN SORT VALUE ====================
  const getSortValue = (fund) => {
    if (
      fund.one_year === undefined ||
      fund.one_year === null ||
      fund.one_year === ""
    ) {
      return null;
    ...
    const numValue =
      typeof fund.one_year === "string"
        ? parseFloat(fund.one_year)
        : fund.one_year;
  ...
  const totalRecords = sortedFunds?.length ?? 0;
  ...
  const paginatedFunds = useMemo(() => {
    ...
    return sortedFunds.slice(startIndex, endIndex);
      ...
      <div className="w-full max-w-[1600px] mx-auto px-4 md:px-6 lg:px-10">
        ...
        <div className="text-center mb-8 md:mb-10">
          ...
          <div className="max-w-3xl mx-auto text-sm text-gray-500 leading-relaxed space-y-1">
            <p>
              Select at least one filter to narrow down your fund search.
            </p>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition-all duration-200 hover:shadow-md">
          <div className="overflow-x-auto max-h-[580px] overflow-y-auto">
            <table className="min-w-[1200px] w-full table-fixed border-collapse text-[11px] sm:text-[12px]">
              <thead className="sticky top-0 z-20">
                <tr>
                  <th className="bg-[#5FB3CE] border border-white/20 px-3 py-2 w-[10%] text-left align-middle text-white text-xs font-bold uppercase tracking-wider">
                    Symbol
                  </th>

                  <th className="bg-[#5FB3CE] border border-white/20 px-3 py-2 w-[22%] text-left align-middle text-white text-xs font-bold uppercase tracking-wider">
                    Fund Name
                  </th>

                  <th className="bg-[#8ED973] border border-white/20 px-3 py-2 w-[9%] text-left align-middle text-white text-xs font-bold uppercase tracking-wider">
                    Asset
                  </th>
                  ...
                  <th className="bg-[#8ED973] border border-white/20 px-3 py-2 w-[13%] text-left align-middle text-white text-xs font-bold uppercase tracking-wider">
                    Strategy
                  </th>
                  ...
                  <th
                    className="bg-[#F1A983] border border-white/20 px-3 py-2 w-[7%] text-right align-middle text-white text-xs font-bold uppercase tracking-wider cursor-pointer select-none"
                  ...
                  <th className="bg-[#D86DCD] border border-white/20 px-3 py-2 w-[13%] text-left align-middle text-white text-xs font-bold uppercase tracking-wider">
                    Fund Link
                  </th>

                  <th className="bg-[#D2D2D2] border border-white/20 px-3 py-2 w-[8%] text-center align-middle text-gray-700 text-xs font-bold uppercase tracking-wider">
                    Rank
                  </th>
                </tr>
              </thead>
              ...
              <tbody>
                ...
                {loading ? (
                  ...
                  paginatedFunds.map((fund, index) => {
                    const isFundLoading =
                      loadingFund === (fund.id ?? fund.fundatakey);

                    const returnValue = formatOneYearReturn(
                      fund.one_year
                    );
                    ...
                    return (
                      ...
                      >
                        {/* Symbol */}
                        <td className="border border-gray-100 px-3 py-2 text-left align-middle font-semibold text-gray-800 whitespace-nowrap">
                        ...
                        {/* Fund Name */}
                        <td className="border border-gray-100 px-3 py-2 text-left align-middle text-blue-700 font-medium">
                        ...
                        {/* Asset */}
                        <td className="border border-gray-100 px-3 py-2 text-left align-middle text-black break-words">
                        ...
                        {/* 1Y Return */}
                        <td className="border border-gray-100 px-3 py-2 text-right align-middle whitespace-nowrap">
                          {returnValue !== null ? (
                            <span
                              className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full font-bold text-xs ${returnBg} ${returnColor}`}
                            >
                              {returnIcon}
                        ...
                        {/* Fund Link */}
                        <td className="border border-gray-100 px-3 py-2 text-left align-middle whitespace-nowrap">
                        ...
                        {/* Rank */}
                        <td className="border border-gray-100 px-3 py-2 text-center align-middle whitespace-nowrap">
          ...
          {/* ==================== FOOTER ==================== */}
          <div className="border-t border-gray-100 px-4 md:px-5 py-2 bg-gray-50/80">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              ...
              <div className="flex items-center justify-center gap-1.5 flex-wrap">
                ...
                <button
                  ...
                  className={`inline-flex items-center justify-center gap-1 h-8 px-2.5 rounded-lg border text-xs font-medium transition-all ${
            ...
            {/* Bottom Status */}
            <div className="flex items-center justify-center md:justify-between mt-3 pt-2 border-t border-gray-200/70">
